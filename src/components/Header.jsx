    ...
    <div className='header bg-white border-b shadow-sm sticky top-0 z-50'>
      <header className='header-menu flex justify-between items-center px-3 max-w-6xl mx-auto'>
        <div className="header-menu logo-img">
          <img src="https://static.rdc.moveaws.com/images/logos/rdc-logo-default.svg" alt="realtor-clone-app-with-react-app-logo" className='h-5 cursor-pointer' onClick={() => navigate("/")} />
        </div>
        <div className="menu-header">
          <ul className='header-menu-ul flex space-x-10'>
            ...
            <li className={`cursor-pointer py-3 text-sm font-semibold text-gray-400 border-b-[3px] border-b-transparent ${(pathMatchRoute("/register") || pathMatchRoute("/profile")) && "text-black border-b-red-500"}`}
