      ...
      <header className='header-menu flex justify-between items-center px-3 max-w-6xl mx-auto'>
        ...
        <div className="menu-header">
          <ul className='header-menu-ul flex space-x-10'>
            ...
            <li className={`cursor-pointer py-3 text-sm font-semibold text-gray-400 border-b-[3px] border-b-transparent ${pathMatchRoute("/register") && "text-black border-b-red-500"}`}
